...
namespace EfwControls.CustomControl
{
    ...
    internal partial class ComboShowCard : DevComponents.DotNetBar.Controls.TextBoxDropDown
    {
        public ComboShowCard()
        {
            InitializeComponent();
            ...
            this.ButtonDropDownClick += new CancelEventHandler(TextShowCard_ButtonDropDownClick);
        }

        void TextShowCard_ButtonDropDownClick(object sender, CancelEventArgs e)
        {
            //OnEnter(e);
